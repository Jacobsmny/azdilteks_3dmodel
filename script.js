...
const services = {
    ...
    service2: {
        ...
        description: {
            ru: 'Уборка квартиры',
            uz: 'Kvartirani tozalash tozalash',
    ...
    service5: {
        ...
        description: {
            ru: 'Уборка склада',
            uz: 'Omborni tozalash',
            en: 'Warehouse cleaning'
        },
        price: 15000,
        photo: 'photos/warehouse.png'
    },
    service6: {
        key: 'service6',
        title: {
        ...
        description: {
            ru: 'Уборка супер маркета',
            uz: 'Super marketni tozalash',
            en: 'Super Market cleaning'
        },
        price: 15000,
        photo: 'photos/supermarket.png'
    },
    service7: {
        key: 'service7',
        title: {
        ...
        description: {
            ru: 'Уборка автосалона',
            uz: 'Avtosalonni tozalash',
            en: 'Car showroom cleaning'
        },
        price: 15000,
        photo: 'photos/carshowroom.png'
    },
    service8: {
        key: 'service9',
        title: {
        ...
        description: {
            ru: 'Уборка садика',
            uz: 'Bog`chani tozalash',
            en: 'Kinder garden cleaning'
        },
        price: 15000,
        photo: 'photos/kindergarten.png'
    },
    ...
    service9: {
        ...
        description: {
            ru: 'Уборка школы',
            uz: 'Maktabni tozalash',
            en: 'School cleaning'
        },
        price: 25000,
        photo: 'photos/school.png'
    },
    service10: {
        key: 'service10',
        title: {
        ...
        description: {
            ru: 'Уборка института',
            uz: 'Institutni tozalash',
            en: 'Institute cleaning'
        },
        price: 20000,
        photo: 'photos/institute.png'
    },
    service11: {
        key: 'service11',
        title: {
        ...
        description: {
            ru: 'Уборка учебного центра',
            uz: 'O`quv markazni tozalash',
            en: 'Learning center cleaning'
        },
        price: 20000,
        photo: 'photos/trainingcenter.png'
    },
    service12: {
        key: 'service12',
        title: {
        ...
        description: {
            ru: 'Уборка дачи',
            uz: 'Oromgohni tozalash',
            en: 'Cottage cleaning'
        },
        price: 20000,
        photo: 'photos/cottage.png'
    },
    service13: {
        key: 'service13',
        title: {
        ...
        description: {
            ru: 'Уборка бассейна',
            uz: 'Basseynni tozalash',
            en: 'Pool cleaning'
        },
        price: 20000,
        photo: 'photos/pool.png'
    },
    service14: {
        key: 'service3',
        title: {
