...
window.onload = function() {
    ...
    renderServices();
    initMainPage();  // Инициализация кнопок на главной странице
};

// Переход на страницу конкретной уборки
function goToServicePage(serviceType) {
    const pages = {
    ...
    window.location.href = pages[serviceType];
}

// Инициализация главной страницы
function initMainPage() {
    document.querySelector('.icon-warehouse').addEventListener('click', () => goToServicePage('warehouse'));
    document.querySelector('.icon-office').addEventListener('click', () => goToServicePage('office'));
    document.querySelector('.icon-yard').addEventListener('click', () => goToServicePage('yard'));
    document.querySelector('.icon-apartment').addEventListener('click', () => goToServicePage('apartment'));
    document.querySelector('.icon-pool').addEventListener('click', () => goToServicePage('pool'));
}
